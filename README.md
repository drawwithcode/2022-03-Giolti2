# Smile!
A small website that snaps a polaroid from the webcam and lets you move it around.

The site doesn't communicate with any server, any and all data recorded is saved locally and for the duration of the browser window.
